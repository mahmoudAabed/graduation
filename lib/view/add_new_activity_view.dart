...
import 'package:graduation/core/view_model/add_activity_model.dart';
import 'package:graduation/view/control_view.dart';

class AddNewActivityView extends StatelessWidget {
  const AddNewActivityView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<AddActivityModel>(
      init: AddActivityModel(),
      builder: (controller) {
        return Scaffold(
            appBar: AppBar(
